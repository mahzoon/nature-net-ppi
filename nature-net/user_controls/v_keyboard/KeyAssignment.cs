...
namespace nature_net.user_controls
{
    ...
    public class KeyAssignment
    {
        ...
        public KeyAssignment(bool isalt, bool isctrl, bool isshift, bool iscaps)
        {
            IsALTKey = isalt;
            IsCAPSLOCK = iscaps;
            IsControlKey = isctrl;
        ...
        [XmlAttribute("isshiftkey")]
        public bool IsSHIFTKey { get; set; }

        [XmlAttribute("iscontrolkey")]
        public bool IsControlKey { get; set; }

        [XmlAttribute("isaltkey")]
        public bool IsALTKey { get; set; }

        [XmlAttribute("iscapslockkey")]
